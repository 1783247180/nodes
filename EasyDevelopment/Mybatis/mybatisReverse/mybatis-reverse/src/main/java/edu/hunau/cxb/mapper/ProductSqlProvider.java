...
import edu.hunau.cxb.pojo.ProductExample.Criteria;
import edu.hunau.cxb.pojo.ProductExample.Criterion;
...
public class ProductSqlProvider {
    ...
    public String countByExample(ProductExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("producer");
    ...
    public String insertSelective(Product record) {
        ...
        if (record.getPpassword1() != null) {
            sql.VALUES("ppassword1", "#{ppassword1,jdbcType=VARCHAR}");
        }
        
        if (record.getPpassword2() != null) {
            sql.VALUES("ppassword2", "#{ppassword2,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(ProductExample example) {
        ...
        sql.SELECT("pname");
        sql.SELECT("ppassword1");
        sql.SELECT("ppassword2");
        sql.FROM("producer");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPpassword1() != null) {
            sql.SET("ppassword1 = #{record.ppassword1,jdbcType=VARCHAR}");
        }
        
        if (record.getPpassword2() != null) {
            sql.SET("ppassword2 = #{record.ppassword2,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Product record) {
        ...
        if (record.getPname() != null) {
            sql.SET("pname = #{pname,jdbcType=VARCHAR}");
        }
        
        if (record.getPpassword1() != null) {
            sql.SET("ppassword1 = #{ppassword1,jdbcType=VARCHAR}");
        }
        
        if (record.getPpassword2() != null) {
            sql.SET("ppassword2 = #{ppassword2,jdbcType=VARCHAR}");
        }
